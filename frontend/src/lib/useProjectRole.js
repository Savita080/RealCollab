// lib/useProjectRole.js — returns current user's role in a project
...
export function useProjectRole(workspaceId, projectId, workspaceRole) {
  ...
  useEffect(() => {
    ...
    // Workspace ADMIN/OWNER always have access (super admin bypass)
    ...
    projApi.members(workspaceId, projectId)
      .then(({ data }) => {
        ...
        // Access = project member OR workspace admin/owner
